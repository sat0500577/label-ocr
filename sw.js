...
const PRECACHE = ['./', './index.html', './shortcut.html', './ocr-image.js', './numbering.js', './numbering.css', './manifest.json', './icon.png'];
const SCRIPTS = ['./vendor/tesseract.min.js', './vendor/worker.min.js', './vendor/jszip.min.js'];
